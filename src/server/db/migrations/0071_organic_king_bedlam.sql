...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-07-22T14:52:40.081Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-22T14:52:40.081Z"' NOT NULL
);
...
CREATE TABLE `__new_media` (
	...
	`backdrop_path` text,
	`characters` text,
	`created_at` integer DEFAULT '"2026-07-22T14:52:40.082Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-22T14:52:40.082Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-07-22T14:52:40.083Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-22T14:52:40.083Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-07-22T14:52:40.078Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-22T14:52:40.078Z"' NOT NULL
);
--> statement-breakpoint
