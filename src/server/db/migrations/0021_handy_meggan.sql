...
CREATE TABLE `__new_media_genres` (
	...
	FOREIGN KEY (`media_id`) REFERENCES `media`(`media_id`) ON UPDATE no action ON DELETE no action,
...
CREATE TABLE `__new_genres` (
	...
	`genre_id` integer NOT NULL,
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-23T15:05:47.167Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T15:05:47.167Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-23T15:05:47.166Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T15:05:47.166Z"' NOT NULL
);
--> statement-breakpoint
