...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-12T15:57:48.109Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-12T15:57:48.109Z"' NOT NULL
);
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-06-12T15:57:48.110Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-12T15:57:48.110Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-06-12T15:57:48.108Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-12T15:57:48.108Z"' NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE `media_user` ADD `user_rating` integer;