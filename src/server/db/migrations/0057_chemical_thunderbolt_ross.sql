...
CREATE TABLE `__new_genres` (
	`id` integer PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-05T14:46:36.088Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-05T14:46:36.088Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-06-05T14:46:36.089Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-05T14:46:36.089Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-06-05T14:46:36.087Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-05T14:46:36.087Z"' NOT NULL
);
--> statement-breakpoint
