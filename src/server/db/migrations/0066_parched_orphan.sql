...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-21T20:52:04.118Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-21T20:52:04.118Z"' NOT NULL
);
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-06-21T20:52:04.117Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-21T20:52:04.117Z"' NOT NULL
);
--> statement-breakpoint
