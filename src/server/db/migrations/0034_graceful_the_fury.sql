...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-23T21:40:49.209Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T21:40:49.209Z"' NOT NULL
);
...
CREATE TABLE `__new_media` (
	...
	`characters` text,
	`similar` text,
	`created_at` integer DEFAULT '"2026-05-23T21:40:49.210Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T21:40:49.210Z"' NOT NULL
);
--> statement-breakpoint
