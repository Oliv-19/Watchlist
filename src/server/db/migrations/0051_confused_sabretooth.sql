...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-25T15:57:05.382Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-25T15:57:05.382Z"' NOT NULL
);
...
CREATE TABLE `__new_media` (
	...
	`backdrop_path` text,
	`characters` text,
	`created_at` integer DEFAULT '"2026-05-25T15:57:05.383Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-25T15:57:05.383Z"' NOT NULL
);
--> statement-breakpoint
