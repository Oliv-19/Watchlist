...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-23T12:46:21.378Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T12:46:21.378Z"' NOT NULL
);
...
CREATE TABLE `__new_media` (
	...
	`characters` text,
	`similar` text,
	`created_at` integer DEFAULT '"2026-05-23T12:46:21.379Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T12:46:21.379Z"' NOT NULL
);
--> statement-breakpoint
