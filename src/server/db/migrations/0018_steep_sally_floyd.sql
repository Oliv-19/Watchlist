DROP TABLE `media_to_genres`;--> statement-breakpoint
PRAGMA foreign_keys=OFF;--> statement-breakpoint
CREATE TABLE `__new_genres` (
	`id` integer PRIMARY KEY NOT NULL,
	`genre_id` integer NOT NULL,
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-23T13:22:12.134Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T13:22:12.134Z"' NOT NULL
);
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-23T13:22:12.133Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T13:22:12.133Z"' NOT NULL
);
--> statement-breakpoint
