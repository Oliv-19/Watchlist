...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-20T15:43:58.826Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-20T15:43:58.826Z"' NOT NULL
);
...
CREATE TABLE `__new_media` (
	...
	`backdrop_path` text,
	`characters` text,
	`created_at` integer DEFAULT '"2026-06-20T15:43:58.827Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-20T15:43:58.827Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-06-20T15:43:58.828Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-20T15:43:58.828Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-06-20T15:43:58.823Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-20T15:43:58.823Z"' NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE `media_user` ADD `status` status DEFAULT 'saved' NOT NULL;