...
CREATE TABLE `__new_genres` (
	`id` integer PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-02T11:13:00.326Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-02T11:13:00.326Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_media` (
	...
	`backdrop_path` text,
	`characters` text,
	`created_at` integer DEFAULT '"2026-06-02T11:13:00.327Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-02T11:13:00.327Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-06-02T11:13:00.328Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-02T11:13:00.328Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-06-02T11:13:00.325Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-02T11:13:00.325Z"' NOT NULL
);
--> statement-breakpoint
