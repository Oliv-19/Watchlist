...
CREATE TABLE `__new_media` (
	...
	`characters` text,
	`similar` text,
	`created_at` integer DEFAULT '"2026-05-23T12:25:12.990Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T12:25:12.990Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-23T12:25:12.989Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T12:25:12.989Z"' NOT NULL
);
--> statement-breakpoint
