...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-28T19:43:24.591Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-28T19:43:24.591Z"' NOT NULL
);
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-05-28T19:43:24.592Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-28T19:43:24.592Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-28T19:43:24.590Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-28T19:43:24.590Z"' NOT NULL
);
--> statement-breakpoint
