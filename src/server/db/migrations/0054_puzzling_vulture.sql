...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-28T19:56:49.125Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-28T19:56:49.125Z"' NOT NULL
);
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-28T19:56:49.124Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-28T19:56:49.124Z"' NOT NULL
);
--> statement-breakpoint
