...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-10T14:48:42.804Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-10T14:48:42.804Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-06-10T14:48:42.805Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-10T14:48:42.805Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-06-10T14:48:42.801Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-10T14:48:42.802Z"' NOT NULL
);
--> statement-breakpoint
