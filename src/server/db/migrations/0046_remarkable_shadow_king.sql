...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-24T12:46:09.412Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-24T12:46:09.412Z"' NOT NULL
);
...
CREATE TABLE `__new_people` (
	...
	`birthday` text,
	`all_media` text,
	`created_at` integer DEFAULT '"2026-05-24T12:46:09.413Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-24T12:46:09.413Z"' NOT NULL
);
--> statement-breakpoint
