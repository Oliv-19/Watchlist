...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-02T20:47:41.896Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-02T20:47:41.896Z"' NOT NULL
);
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-06-02T20:47:41.897Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-02T20:47:41.897Z"' NOT NULL
);
--> statement-breakpoint
