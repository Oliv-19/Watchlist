CREATE TABLE `genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-22T19:32:11.565Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-22T19:32:11.565Z"' NOT NULL
);
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-22T19:32:11.563Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-22T19:32:11.563Z"' NOT NULL
);
--> statement-breakpoint
