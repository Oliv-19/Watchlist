...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-23T13:40:40.465Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T13:40:40.465Z"' NOT NULL
);
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-23T13:40:40.464Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T13:40:40.464Z"' NOT NULL
);
--> statement-breakpoint
