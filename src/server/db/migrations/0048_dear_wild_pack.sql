...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-25T14:47:20.575Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-25T14:47:20.575Z"' NOT NULL
);
...
CREATE TABLE `__new_media` (
	...
	`backdrop_path` text,
	`characters` text,
	`created_at` integer DEFAULT '"2026-05-25T14:47:20.576Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-25T14:47:20.576Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_people` (
	...
	`birthday` text,
	`all_media` text,
	`created_at` integer DEFAULT '"2026-05-25T14:47:20.577Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-25T14:47:20.577Z"' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_people`("id", "name", "original_name", "biography", "profile_path", "also_known_as", "known_for", "birthplace", "birthday", "all_media", "created_at", "updated_at") SELECT "id", "name", "original_name", "biography", "profile_path", "also_known_as", "known_for", "birthplace", "birthday", "all_media", "created_at", "updated_at" FROM `people`;--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-25T14:47:20.573Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-25T14:47:20.573Z"' NOT NULL
);
--> statement-breakpoint
