...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-10T15:18:47.555Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-10T15:18:47.555Z"' NOT NULL
);
...
CREATE TABLE `__new_media` (
	...
	`backdrop_path` text,
	`characters` text,
	`created_at` integer DEFAULT '"2026-06-10T15:18:47.556Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-10T15:18:47.556Z"' NOT NULL
);
--> statement-breakpoint
