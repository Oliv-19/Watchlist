...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-24T12:31:03.270Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-24T12:31:03.270Z"' NOT NULL
);
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-24T12:31:03.269Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-24T12:31:03.269Z"' NOT NULL
);
--> statement-breakpoint
