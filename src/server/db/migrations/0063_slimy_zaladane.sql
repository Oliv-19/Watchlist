...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-14T15:12:49.068Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-14T15:12:49.068Z"' NOT NULL
);
...
CREATE TABLE `__new_media` (
	...
	`backdrop_path` text,
	`characters` text,
	`created_at` integer DEFAULT '"2026-06-14T15:12:49.069Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-14T15:12:49.069Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-06-14T15:12:49.066Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-14T15:12:49.066Z"' NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE `media_user` ADD `user_review` text;