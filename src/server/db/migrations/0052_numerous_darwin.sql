...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-28T18:53:06.085Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-28T18:53:06.085Z"' NOT NULL
);
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-05-28T18:53:06.087Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-28T18:53:06.087Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-28T18:53:06.084Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-28T18:53:06.084Z"' NOT NULL
);
--> statement-breakpoint
