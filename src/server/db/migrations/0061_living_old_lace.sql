...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-12T13:28:05.359Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-12T13:28:05.359Z"' NOT NULL
);
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-06-12T13:28:05.358Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-12T13:28:05.358Z"' NOT NULL
);
--> statement-breakpoint
