...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-21T20:36:36.281Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-21T20:36:36.281Z"' NOT NULL
);
...
CREATE TABLE `__new_media` (
	...
	`backdrop_path` text,
	`characters` text,
	`created_at` integer DEFAULT '"2026-06-21T20:36:36.282Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-21T20:36:36.282Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-06-21T20:36:36.283Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-21T20:36:36.283Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-06-21T20:36:36.278Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-21T20:36:36.278Z"' NOT NULL
);
--> statement-breakpoint
