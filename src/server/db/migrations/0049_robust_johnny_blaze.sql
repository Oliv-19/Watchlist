...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-25T15:23:32.673Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-25T15:23:32.673Z"' NOT NULL
);
...
CREATE TABLE `__new_media` (
	...
	`backdrop_path` text,
	`characters` text,
	`created_at` integer DEFAULT '"2026-05-25T15:23:32.674Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-25T15:23:32.674Z"' NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_people`("id", "name", "original_name", "order", "biography", "profile_path", "also_known_as", "known_for", "birthplace", "birthday", "all_media", "created_at", "updated_at") SELECT "id", "name", "original_name", "order", "biography", "profile_path", "also_known_as", "known_for", "birthplace", "birthday", "all_media", "created_at", "updated_at" FROM `people`;--> statement-breakpoint
