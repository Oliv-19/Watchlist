...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-25T15:26:53.268Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-25T15:26:53.268Z"' NOT NULL
);
...
CREATE TABLE `__new_media` (
	...
	`backdrop_path` text,
	`characters` text,
	`created_at` integer DEFAULT '"2026-05-25T15:26:53.269Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-25T15:26:53.269Z"' NOT NULL
);
--> statement-breakpoint
