...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-12T13:16:22.133Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-12T13:16:22.133Z"' NOT NULL
);
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-06-12T13:16:22.134Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-12T13:16:22.134Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-06-12T13:16:22.130Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-12T13:16:22.130Z"' NOT NULL
);
--> statement-breakpoint
