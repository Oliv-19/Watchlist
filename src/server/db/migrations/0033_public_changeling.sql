...
CREATE TABLE `__new_genres` (
	...
	`genre_id` integer NOT NULL,
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-23T21:38:58.321Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T21:38:58.321Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-23T21:38:58.320Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T21:38:58.320Z"' NOT NULL
);
--> statement-breakpoint
