...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-24T11:49:18.500Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-24T11:49:18.500Z"' NOT NULL
);
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-24T11:49:18.499Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-24T11:49:18.499Z"' NOT NULL
);
--> statement-breakpoint
