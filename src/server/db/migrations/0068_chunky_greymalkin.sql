...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-07-03T19:05:35.206Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-03T19:05:35.206Z"' NOT NULL
);
...
CREATE TABLE `__new_media` (
	...
	`backdrop_path` text,
	`characters` text,
	`created_at` integer DEFAULT '"2026-07-03T19:05:35.207Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-03T19:05:35.207Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-07-03T19:05:35.208Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-03T19:05:35.208Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-07-03T19:05:35.201Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-03T19:05:35.201Z"' NOT NULL
);
--> statement-breakpoint
