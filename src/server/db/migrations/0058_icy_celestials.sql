DROP TABLE `airing_today`;--> statement-breakpoint
DROP TABLE `on_air`;--> statement-breakpoint
PRAGMA foreign_keys=OFF;--> statement-breakpoint
CREATE TABLE `__new_genres` (
	`id` integer PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-06-06T12:55:44.550Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-06T12:55:44.550Z"' NOT NULL
);
...
CREATE TABLE `__new_people` (
	...
	`birthplace` text,
	`birthday` text,
	`created_at` integer DEFAULT '"2026-06-06T12:55:44.551Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-06-06T12:55:44.551Z"' NOT NULL
);
--> statement-breakpoint
