...
CREATE TABLE `__new_genres` (
	...
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2026-05-23T15:59:31.563Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T15:59:31.563Z"' NOT NULL
);
...
CREATE TABLE `__new_user` (
	...
	`created_at` integer DEFAULT '"2026-05-23T15:59:31.562Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-05-23T15:59:31.562Z"' NOT NULL
);
--> statement-breakpoint
