  ...
  return (
    <form id="searchForm" className="w-60 md:w-75" onSubmit={search}>   
      ...
      <div className="relative">
          ...
          <button type="submit" form="searchForm" className="bg-(--color-bg) absolute text-[0.8rem] font-bold right-0.5 top-0.5 text-white hover:cursor-pointer hover:bg-gray-700 box-border border border-transparen leading-5 rounded-lg px-3 py-1.5 focus:outline-none">Search</button>
      </div>
  </form>
  )
}
