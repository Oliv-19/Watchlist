  ...
  return (
    <form id="searchForm" className="w-75" onSubmit={search}>   
      ...
      <div className="relative">
          ...
          <button type="submit" form="searchForm" className="bg-black absolute text-[0.8rem] font-bold inset-e-1.5 top-0.5 text-white hover:cursor-pointer hover:bg-gray-700 box-border border border-transparen leading-5 rounded px-3 py-1.5 focus:outline-none">Search</button>
      </div>
  </form>
  )
}
